...
if ( ! function_exists( 'cat_project_func' ) ) {

    // Register Custom Taxonomy
    function cat_project_func() {
    
        $labels = array(
            'name'                       => _x( 'Categories Project', 'Taxonomy General Name', 'master-template-woo' ),
            'singular_name'              => _x( 'Category Project', 'Taxonomy Singular Name', 'master-template-woo' ),
            'menu_name'                  => __( 'Category Projects', 'master-template-woo' ),
        ...
        register_taxonomy( 'category_project', array( 'projects' ), $args );
    
    }
    add_action( 'init', 'cat_project_func', 0 );
