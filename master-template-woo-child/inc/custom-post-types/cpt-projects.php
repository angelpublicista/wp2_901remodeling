...
if ( ! function_exists('projects_func') ) {
    ...
    function projects_func() {
        ...
        $labels = array(
            'name'                  => _x( 'Projects', 'Post Type General Name', 'master-template-woo' ),
            'singular_name'         => _x( 'Project', 'Post Type Singular Name', 'master-template-woo' ),
            'menu_name'             => __( 'Projects', 'master-template-woo' ),
            'name_admin_bar'        => __( 'Projects', 'master-template-woo' ),
        ...
        $args = array(
            'label'                 => __( 'Project', 'master-template-woo' ),
