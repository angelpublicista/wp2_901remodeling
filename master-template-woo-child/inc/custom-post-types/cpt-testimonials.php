...
if ( ! function_exists('testimonials_func') ) {

    // Register Custom Post Type
    function testimonials_func() {
    
        $labels = array(
            'name'                  => _x( 'Testimonials', 'Post Type General Name', 'master-template-woo' ),
            'singular_name'         => _x( 'Testimonial', 'Post Type Singular Name', 'master-template-woo' ),
            'menu_name'             => __( 'Testimonials', 'master-template-woo' ),
            'name_admin_bar'        => __( 'Testimonials', 'master-template-woo' ),
        ...
        $args = array(
            'label'                 => __( 'Testimonial', 'master-template-woo' ),
    ...
    add_action( 'init', 'testimonials_func', 0 );
