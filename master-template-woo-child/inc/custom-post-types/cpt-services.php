...
if ( ! function_exists('services_func') ) {

    // Register Custom Post Type
    function services_func() {
    
        $labels = array(
            'name'                  => _x( 'Services', 'Post Type General Name', 'master-template-woo' ),
            'singular_name'         => _x( 'Service', 'Post Type Singular Name', 'master-template-woo' ),
            'menu_name'             => __( 'Services', 'master-template-woo' ),
            'name_admin_bar'        => __( 'Services', 'master-template-woo' ),
        ...
        $args = array(
            'label'                 => __( 'Service', 'master-template-woo' ),
            'description'           => __( 'Post Type para servicios', 'master-template-woo' ),
            'labels'                => $labels,
    ...
    add_action( 'init', 'services_func', 0 );
